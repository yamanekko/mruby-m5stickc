...
//  #define CHMOD(a, b) chmod(a,b)
  ...
  #include <sys/param.h>
  #include <pwd.h>
  #define realpath(N,R) NULL
  #define basename(path) NULL
  #define dirname(path) NULL
#endif
...
{
#if defined(_WIN32) || defined(_WIN64) || defined(ESP32)
...
void
mrb_mruby_m5stickc_file_gem_init(mrb_state* mrb)
{
